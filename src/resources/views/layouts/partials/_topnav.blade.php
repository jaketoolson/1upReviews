...
<header id="topnav">
    <nav class="navbar-custom">
        ...
        <ul class="list-unstyled menu-left mb-0">
            <li class="float-left">
                <a href="/" class="logo side-menu-sm-logo">
                                <span class="logo-lg">
                                    <img src="/assets/images/froggy_text_inverse.png" alt="" height="24">
                                </span>
                    <span class="logo-sm">
                                   <img src="/assets/images/froggy_text_inverse.png" alt="" height="28">
                                </span>
                </a>
            </li>
            <li class="float-left">
